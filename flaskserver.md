...
Выбираем в меню слева пункт "IP-адреса", и потом жмем на кнопку "Зарезервировать адрес", что появится в верхнем правом углу, тут главное проследить, что бы зона доступности, где резервируется адрес была той же, где создается сервер, после чего жмем "Зарезервировать". и возвращаемся к конфигурированию нашей ВМ.
